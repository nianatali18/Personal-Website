    ...
    >
      <nav className="bg-black sticky ">
          ...
          <div className="relative flex items-center justify-between h-16 w-full">
            <div className=" inset-y-0 left-0 flex items-center sm:hidden">
              <button
                ...
                className="inline-flex items-center justify-end p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
              >
        ...
        <div
          className={`${
            isOpen ? "block" : "hidden"
          } sm:hidden flex flex-col px-2 pt-8 pb-3 space-y-1  text-white`}
        >
          <Link
            to="/Home"
